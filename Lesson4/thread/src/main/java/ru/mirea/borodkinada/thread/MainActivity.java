package ru.mirea.borodkinada.thread;
...
import ru.mirea.borodkinada.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: 11, НОМЕР ПО СПИСКУ: 5, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: Пираты Карибского моря");
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        Log.d("ThreadProject", String.format("Запущен поток No (?) студентом группы No 11 %s номер по списку No 5", numberThread, " БСБО-11-21", -1));
